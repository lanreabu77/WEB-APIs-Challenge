var containerQuestionEl = document.getElementById("question-container");
      ...
      var questions = [
        ...
        { q: 'The condition in an if/else statement is enclosed within', 
          a: '3. curly brackets', 
          choices: [{choice: '1. quotes'}, {choice: '2. parenthesis'}, {choice: '3. curly brackets'}, {choice: '4. square brackets'}]
        },
        { q: 'Arrays in Javascript can be used to store', 
          a: '2. all of the above', 
          choices: [{choice: '1. numbers and strings'}, {choice: '2. all of the above'}, {choice: '3. booleans'}, {choice: '4. other arrays'}]
        },
        { q: 'String values must be enclosed within ____ when being assigned to variables.', 
          a: '4. quotes', 
          choices: [{choice: '1. commas'}, {choice: '2. parenthesis'}, {choice: '3.  curly brackets'}, {choice: '4. quotes'}]
        },
        { q: 'A very useful tool used during development and debugging for printing content to the debugger is:', 
          a: '1. console.log', 
          choices: [{choice: 'console.log'}, {choice: '2. javascript'}, {choice: '3. terminal/bash'}, {choice: '4. for loops'}]
        },
